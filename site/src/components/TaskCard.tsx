...
export class TaskCard extends React.Component<Props> {
    ...
    card_onDragOver(event: React.DragEvent<HTMLDivElement>) {
        if (
            0 <= event.dataTransfer.types.indexOf(TaskCard.modifyPrerequisiteMimeType) ||
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    />
                    <TextField placeholder="title" value={task.title} onChangeValue={setTitle} />
                    <TextField placeholder="assignee" value={task.assignee} onChangeValue={setAssignee} />
                </div>
